...
import { DropdownLanguage, DropdownTheme, HeaderMenu, MenuDrawer } from "@components/home";
...
export default function Header({ lng }: { lng: string }) {
    ...
    return (
        <Layout.Header>
            <div className={cn("fixed top-0 right-0 left-0 z-10 lg:py-6 py-0 shadow-none bg-transparent duration-500 ease-int", isScroll && "lg:py-0 py-0 shadow-lg bg-neutral-900")}>
