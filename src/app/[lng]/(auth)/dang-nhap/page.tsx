...
export default async function page({ params: { lng } }: BasePageProps) {
    ...
    const { t } = await useTranslation(lng, "sign-in")
            ...
            <div>
                <form>
                    <div className="flex flex-col items-stretch justify-start gap-6">
                        ...
                        <div className="flex min-[375px]:flex-row flex-col min-[375px]:items-center items-start justify-between gap-3">
                            <div className="form-control">
                                <label className="label cursor-pointer justify-start gap-3">
                                    <input type="checkbox" defaultChecked className="checkbox" />
                                    <span className="label-text text-base">{t("remember-me")}</span>
                                </label>
                            </div>
                            <p className="text-end min-[375px]:w-auto w-full">
            ...
            <div>
                <p className="text-lg text-center">
                    <Trans i18nKey="not-have-account" t={t} components={{
                        1: <Link href="/dang-ky" className="text-blue-500 hover:underline"></Link>
                    }}>
